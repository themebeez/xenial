...
?>
<div class="xe-header-element is-search <?php echo esc_attr( implode( ' ', $args['classes'] ) ); ?>">
	<button class="xe-button xe-false-button xe-header-element-search xe-header-element-search-button">
