...
<div class="xe-header-element is-woo-wishlist-icon">
    <div id="xe-woo-wishlist-icon">
        <a href="<?php echo ( function_exists( 'addonify_wishlist_get_wishlist_page_url' ) ) ? esc_url( addonify_wishlist_get_wishlist_page_url() ) : '#'; ?>" id="xe-wishlist-link">       
            ...
            <span class="count">
                ...
                if ( function_exists( 'addonify_wishlist_get_wishlist_items_count' ) ) {
                    echo addonify_wishlist_get_wishlist_items_count();
                }
                ?>
            </span>
        </a>
