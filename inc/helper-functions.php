...
if ( ! function_exists( 'xenial_recursive_parse_args' ) ) {
	/**
	 ...
	 */
	function xenial_recursive_parse_args( $args, $defaults ) {
		...
		foreach ( $args as $key => $value ) {
			...
			if ( is_array( $value ) && isset( $new_args[ $key ] ) ) {
				...
				$new_args[ $key ] = xenial_recursive_parse_args( $value, $new_args[ $key ] );
			} else {
