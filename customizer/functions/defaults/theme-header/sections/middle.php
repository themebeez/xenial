...
if ( ! function_exists( 'xenial_theme_header_middle_section_defaults' ) ) {
	...
	function xenial_theme_header_middle_section_defaults( $customize_defaults ) {

		$header_middle_section_customize_defaults = apply_filters(
			...
			array(
				...
				'header_middle_section_padding' => array(
					'desktop' => 50,
					'tablet' => '',
					'mobile' => ''
				),
				'header_middle_section_background_color' => '{"desktop":{"initial":""},"tablet":{"initial":""},"mobile":{"initial":""}}',
		...
		$customize_defaults = array_merge( $customize_defaults, $header_middle_section_customize_defaults );

        return $customize_defaults;
	}

	add_filter( 'xenial_customize_defaults', 'xenial_theme_header_middle_section_defaults' );
}