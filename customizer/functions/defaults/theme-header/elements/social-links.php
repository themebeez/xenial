...
if ( ! function_exists( 'xenial_get_header_social_links_customize_defaults' ) ) {
	...
	function xenial_get_header_social_links_customize_defaults( $customize_defaults ) {

		$header_social_links_customize_defaults = apply_filters(
			...
			array(
	            ...
	            'header_social_link_icon_color' => '{"desktop":{"initial":"","hover":""},"tablet":{"initial":"","hover":""},"mobile":{"initial":"","hover":""}}',
	            'header_social_link_title_color' => '{"desktop":{"initial":"","hover":""},"tablet":{"initial":"","hover":""},"mobile":{"initial":"","hover":""}}',
	            'header_social_link_background_color' => '{"desktop":{"initial":"","hover":""},"tablet":{"initial":"","hover":""},"mobile":{"initial":"","hover":""}}',
	            'header_social_link_border_color' => '{"desktop":{"initial":"","hover":""},"tablet":{"initial":"","hover":""},"mobile":{"initial":"","hover":""}}',
			)
		);

		$customize_defaults = array_merge( $customize_defaults, $header_social_links_customize_defaults );

        return $customize_defaults;
	}

	add_filter( 'xenial_customize_defaults', 'xenial_get_header_social_links_customize_defaults' );
}