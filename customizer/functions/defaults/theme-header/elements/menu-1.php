	...
	function xenial_get_header_primary_menu_customize_defaults() {
		...
		return apply_filters(
			...
			array(
	            ...
	            'primary_menu_top_level_items_color' => '{"initial":"","link":"","hover":"","active":""}',
	            'primary_menu_top_level_items_background_color' => '{"initial":"","link":"","hover":"","active":""}',
	...
	function xenial_get_header_primary_menu_dropdown_customize_defaults() {
		...
		return apply_filters(
			...
			array(
	            ...
	            'primary_menu_dropdown_items_divider_color' => '{"initial":"","link":"","hover":"","active":""}',            
	            'primary_menu_dropdown_items_color' => '{"initial":"","link":"","hover":"","active":""}',
	            'primary_menu_dropdown_items_background_color' => '{"initial":"","link":"","hover":"","active":""}',
