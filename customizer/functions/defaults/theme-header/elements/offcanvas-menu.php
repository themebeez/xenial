...
if ( ! function_exists( 'xenial_offcanvas_menu_customize_defaults' ) ) {
	...
	function xenial_offcanvas_menu_customize_defaults( $customize_defaults ) {

		$offcanvas_menu_customize_defaults = apply_filters(
			...
			array(
	            ...
	            'offcanvas_menu_item_divider_color' => '{"initial":""}',
	            'offcanvas_menu_item_color' => '{"initial":"","hover":"","active":""}',
	            ...
	            'offcanvas_menu_submenu_toggle_button_background_color' => '{"initial":"","hover":""}',
	            'offcanvas_menu_submenu_toggle_button_label_color' => '{"initial":"","hover":""}',
		...
		$customize_defaults = array_merge( $customize_defaults, $offcanvas_menu_customize_defaults );

        return $customize_defaults;
	}

	add_filter( 'xenial_customize_defaults', 'xenial_offcanvas_menu_customize_defaults' );
}
