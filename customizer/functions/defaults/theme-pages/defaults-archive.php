...
if ( ! function_exists( 'xenial_get_customizer_default_archive_page_values' ) ) {
    ...
    function xenial_get_customizer_default_archive_page_values( $customize_defaults ) {

        $archive_page_customize_defaults = apply_filters( 
            'xenial_archive_page_customize_defaults_filter', 
            array(
        ...
        $customize_defaults = array_merge( $customize_defaults, $archive_page_customize_defaults );

        return $customize_defaults;
    }

    add_filter( 'xenial_customize_defaults', 'xenial_get_customizer_default_archive_page_values' );
}