...
if ( ! function_exists( 'xenial_get_footer_widget_area_4_customize_defaults' ) ) {
	...
	function xenial_get_footer_widget_area_4_customize_defaults( $customize_defaults ) {

		$footer_widget_area_4_customize_defaults = apply_filters(
		...
		$customize_defaults = array_merge( $customize_defaults, $footer_widget_area_4_customize_defaults );

        return $customize_defaults;
	}

	add_filter( 'xenial_customize_defaults', 'xenial_get_footer_widget_area_4_customize_defaults' );
}