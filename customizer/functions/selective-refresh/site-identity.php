 ...
 */
if ( ! function_exists( 'xenial_site_identity_selective_refresh' ) ) {

	function xenial_site_identity_selective_refresh( $wp_customize ) {
	...
	add_action( 'customize_register', 'xenial_site_identity_selective_refresh' );
}
