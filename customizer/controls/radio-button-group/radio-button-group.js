wp.customize.controlConstructor['xenial-radio-button-group-control'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		var control = this,
			desktop_slider 			= control.container.find( '.xenial-slider.desktop-slider' ),
