...
xenial_select_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu']
	]
);
...
xenial_button_checkbox_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_visibility']
	]
);
...
xenial_radio_button_group_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_alignment']
	],
	true
);
...
xenial_range_control_field(
	...
	[
		...
		'defaults' => $xenial_customizer_defaults['header_secondary_menu_items_spacing']
	]
);
...
xenial_range_control_field(
	...
	[
		...
		'input_attrs' => ['min' => 0, 'max' => 100, 'step' => 1, 'responsive' => true],
		'defaults' => $xenial_customizer_defaults['header_secondary_menu_font_size']
	]
);
...
xenial_range_control_field(
	...
	[
		...
		'defaults' => $xenial_customizer_defaults['header_secondary_menu_line_height']
	]
);
...
xenial_select_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_font_weight']
	]
);
...
xenial_radio_button_group_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_font_style']
	],
	false
);
...
xenial_radio_button_group_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_text_transform']
	],
	false
);
...
xenial_color_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_link_color']
	],
	false
);
...
xenial_color_field(
	...
	[
		...
		'default' => $xenial_customizer_defaults['header_secondary_menu_link_hover_color']
	],
	false
);