...
xenial_color_field(
	...
	array(
		...
		'default' => xenial_get_customize_default( 'header_top_section_background_color')
	),
	true
);
...
xenial_info_field(
	'header_top_section_border_top_fields_title',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
...
xenial_select_field(
	'header_top_section_border_top_style',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
		'label' => esc_html__( 'Border Style', 'xenial' ),
		'choices' => xenial_get_border_styles(),
		'default' => xenial_get_customize_default( 'header_top_section_border_top_style' )
	)
);


xenial_range_control_field(
	'header_top_section_border_top_width',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
		...
		'defaults' => xenial_get_customize_default( 'header_top_section_border_top_width' )
	)
);
...
xenial_color_field(
	...
	array(
		...
		'default' => xenial_get_customize_default( 'header_top_section_border_top_color')
	),
	true
);
...
xenial_divider_field( 
	'header_top_section_fields_divider_5', 
	array(
		'priority' => 10,
		'section' => 'xenial_top_header', 
	)
...
xenial_info_field(
	'header_top_section_border_bottom_fields_title',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
...
xenial_select_field(
	'header_top_section_border_bottom_style',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
		'label' => esc_html__( 'Border Style', 'xenial' ),
		'choices' => xenial_get_border_styles(),
		'default' => xenial_get_customize_default( 'header_top_section_border_bottom_style' )
	)
);

xenial_range_control_field(
	'header_top_section_border_bottom_width',
	array(
		'priority' => 10,
		'section' => 'xenial_top_header',
		'label' => esc_html__( 'Border Width', 'xenial' ),
		...
		'defaults' => xenial_get_customize_default( 'header_top_section_border_bottom_width' )
	)
);
...
xenial_color_field(
	...
	array(
		...
		'section' => 'xenial_top_header',
		'label' => esc_html__( 'Border Color', 'xenial' ),
		'default' => xenial_get_customize_default( 'header_top_section_border_bottom_color')
	),
	true
);